...
public:
    ...
    const std::deque<const Cell *> &GetAffectOn() const;
...
private:
    ...
    public:
        ...
        virtual std::vector<const Cell *> GetReferencedCellsPtr() const;
    ...
    public:
        ...
        std::vector<const Cell *> GetReferencedCellsPtr() const override;
